<div class="main">
    ...
    <input placeholder="Название заметки" type="text" id="name" name="name" value="" disabled><br>
    <br>
    <textarea placeholder="Описание заметки" type="text" id="description" name="description" value="" disabled></textarea ><br><br>
